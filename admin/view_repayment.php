...
$get_repayments = get_rows_from_one_table('repayment_tbl','date_created');
?>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Repayments</h1>
              ...
              <div class="table-responsive">
                <table class="table table-bordered" id="myTable" width="100%" cellspacing="0">
                 ...
                 <?php if($get_repayments == null){
                  ...
                  <tr>
                    ...
                    <th scope="col">Amount Paid so Far</th>
                ...
                <tbody>
                  <?php
                   ...
                   foreach($get_repayments as $value){
                    $get_user = get_one_row_from_one_table_by_id('users','unique_id', $value['user_id'], 'registered_on');
                    $get_loan = get_one_row_from_one_table_by_id('user_loan_details','unique_id', $value['loan_id'], 'date_created');
                    $get_loan_type = get_one_row_from_one_table_by_id('loan_category','unique_id',$get_loan['loan_category_id'], 'date_created');
                    //$get_loan_package = get_one_row_from_one_table_by_id('loan_packages','unique_id',$value['loan_package_id'], 'date_created');
                     ...
                     <tr>
                        ...
                        <td>
                            &#8358;<?php echo number_format($value['total_amount_to_pay'], 2);?>
                        </td>
                        <td>
                            &#8358;<?php echo number_format($value['amount_deducted_per_month'], 2);?>
                        </td>
                        <td>
                            &#8358;<?php echo number_format($value['amount_paid_so_far'], 2);?>
                        </td>
                        <td>
                        ...
                        <td>
                            <?php 
                                if($get_loan['no_of_repayment_month'] == $value['current_repayment_month']){
