...
$get_vehicle_reg_request = get_rows_from_one_table_by_id('vehicle_reg_installment','approval_status', 0 , 'date_created');
?>
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="myTable" width="100%" cellspacing="0">
                 ...
                 <?php if($get_vehicle_reg_request == null){
                ...
                <tbody>
                  <?php
                   ...
                   foreach($get_vehicle_reg_request as $value){
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form method="post" id="accept_vehicle_installment_form">
                ...
                <div class="modal-footer">
                  <button type="button" class="btn btn-primary" id="accept_vehicle_installment_btn">Approve</button>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <form method="post" id="reject_vehicle_installment_form">
                    <input type="hidden" name="unique_id"  id="unique_id2" value="">
                    <input type="hidden" name="approval_status"  id="approval_status" value="2">
                  </form>
                </div>
                <div class="modal-footer">
                  <button type="button" class="btn btn-primary" id="reject_vehicle_installment_btn">Yes</button>
                  <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                </div>
              </div>
            </div>
