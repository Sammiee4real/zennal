      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <form method="post" id="upload_document_form">
                <div class="row justify-content-center">
                  ...
                  <input type="hidden" name="document_url" id="document_url">
                   <div class="col-md-8 mt-3">
                    <button type="button" class="btn btn-secondary" id="upload_document">Save Document</button>
                  </div>
                </div>
              </form>
            </div>
  ...
  <script>
    $(document).ready(function(){
      $(document).on('change', '#file', function(){
            ...
            if(jQuery.inArray(image_extension, ['png', 'jpg', 'jpeg', 'pdf', 'doc', 'docx', 'xls', 'csv']) == -1){
              alert("Invalid File");
