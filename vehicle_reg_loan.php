...
<script type="text/javascript">
    $(function() {
        $('#colorselector').change(function(){
            ...
            var target = $("#colorselector").find("option:selected").attr("target");
                                            ...
                                            <select name="employment_status" class="form-select" id="colorselector">
                                                ...
                                                <?php
                                                    foreach ($employment_statuses as $employment_status) {
                                                        # code...
                                                        $status_id = $employment_status['id'];
                                                        $status_name = $employment_status['status_name'];

                                                        $target = "";

                                                        if($status_name == "NYSC" || $status_name == "Salary Earner"){
                                                            $target = "red";
                                                        }elseif($status_name == "Unemployed" || $status_name == "Self-Employed" || $status_name == "Business Owner"){
                                                            $target = "yellow";
                                                        }
                                                ?>
                                                <option value="<?php echo $status_id;?>" target="<?=$target;?>">
