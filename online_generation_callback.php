...
if($response_decode['data']['status'] == "successful"){
	...
	if($insert_transaction_decode['status'] == "1"){
		echo '<meta http-equiv="refresh" content="0; url=loan_purpose.php?message=transaction_successful&transaction_id='.$transaction_id.'" />';
	}else{
		echo '<meta http-equiv="refresh" content="0; url=loan_purpose.php?message=transaction_failed" />';
	}
}else{
	echo '<meta http-equiv="refresh" content="0; url=loan_purpose.php?message=transaction_failed" />';
	//echo "failed";
