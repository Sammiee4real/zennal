    ...
    <!-- <script type="application/javascript" src="assets/vendors/simple-datatables/simple-datatables.js"></script> -->
    <!-- <script type="application/javascript" src="assets/js/vendors.js"></script> -->
    <script type="application/javascript" src="assets/vendors/chartjs/Chart.min.js"></script>
    <script type="application/javascript" src="assets/vendors/apexcharts/apexcharts.min.js"></script>
    <!-- <script type="application/javascript" src="assets/js/pages/dashboard.js"></script> -->
    <script type="application/javascript" src="assets/js/main.js"></script>
    <script type="application/javascript" src="assets/js/wizard.js"></script>
    <script type="application/javascript" src="assets/js/debounce.js"></script>
    <script type="application/javascript" src="assets/vendors/sweetalert2/package/dist/sweetalert2.min.js"></script>
