...
<div class="main-content container-fluid">
    <div class="page-title">
        <h3>Submit Bank Statement</h3>
        <p class="text-subtitle text-muted">Submit your bank statement for us to consider you for intallmental payment</p>
    </div>
...
<div class="col-md-8 col-sm-12 mx-auto">
            ...
            <div class="card pt-4">
                <div class="card-body">
                    <form action="" method="post" id="submit_vehicle_reg_installment_form">
                        <div class="form-group position-relative has-icon-left">
                            ...
                            <div class="clearfix mt-3">
                                <button class="btn btn-primary btn-block" id="submit_vehicle_reg_installment">Submit</button>
                            </div>
                        </div>
